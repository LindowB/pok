...
export default class Pokemon extends Component {
    ...
    async componentDidMount(){
        ...
        // get pokemon description, catch rate , eggroups , gender ratio , hatch steps
                        ...
                        <div className="card-body">
                            <div className="row align-items-center">
                                ...
                                <div className="col-md-9">
                                    <h4 className="mx-auto">{this.state.name.toLowerCase().split('-')
                                                                            .map(s => s.charAt(0)
                                                                            .toUpperCase()+ s.substring(1))
                                                                            .join(' ')}
                                    </h4>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="row">
                                        <div className="col-md-6"><h6 className="float-right">Height:</h6>
                                        </div>
